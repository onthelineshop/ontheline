            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-3 benefit_area_text">
                        ...
                        <h4>We care about your </br> budget and comfort.</h4>
        ...
        <div class="container">
                ...
                <div class="col-md-12 mar_pad_reset">
                    <div class="big_banner_init">
                        <a class="bestbuy_banner big_banner_style" href="#">
                            ...
                            <img class="bestbuy_img" src="img/banners/bestbuy.svg" alt="">
            ...
            <div class="row content_margine">
                ...
                <div class="col-md-4 sm_banner_1">
                    <div class="sm_banner_init customer_background">
                        <a class="customer_care_banner" href="#">
                            <h2>CUSTOMER</br>CARE</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                            <div class="link_arrow color_green">
                                <img class="arrow_svg" src="img/svg/arrow.svg" alt="arrow">
